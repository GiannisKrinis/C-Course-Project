...
public:
	...
	Nemo(GameState* gs, const std::string& name, int x, int y) : GameObject(gs, name) {//x,y σε ποια θεση ειναι αρχικα o Nemo
	...
	void init() {
		x = 1100; //αρχικοποιω στην init το x ετσι ωστε να ξεκιναει οταν αρχικοποιειται σε συγκεκριμενη θεση χ
	}
